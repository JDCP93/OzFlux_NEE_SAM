OzFluxProcess_Dates = function(Site,StartDate = "1900-01-01",EndDate="2100-01-01"){
  ...
  #  - StartDate: A datatime in the form "YYYY-MM-DD" that marks start of 
  #               required data, inclusive
  #  - EndDate: A datatime in the form "YYYY-MM-DD" that marks end of 
  #               required data, inclusive
  #  
  #  OUTPUTS:
  #  -
  ...
  # Trim the data to the dates specified
  Data_day = Data_day[(Data_day$TIMESTAMP >= StartDate & Data_day$TIMESTAMP <= EndDate),]
  ...
  assign(name,output)
  save(list=c(name),file=paste0(name,"_",StartDate,"_",EndDate,".Rdata"))
