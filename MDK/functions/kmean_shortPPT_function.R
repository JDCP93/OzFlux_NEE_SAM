...
kmean_shortPPT = function(Site,k,MaxDate){
...
climate = cbind(input$clim,input$NDVI,input$ppt[,1:8])
...
save(output,file = paste0("output/kmeans_shortPPT_",k,"cluster_output_",Site,".Rdata"))
