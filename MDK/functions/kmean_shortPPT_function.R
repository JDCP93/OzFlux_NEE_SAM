...
kmean_shortPPT = function(Site,k,MinDate,MaxDate){
...
climate = cbind(input$clim,input$NDVI,input$ppt[,1:7])
...
# Reshape the data
center_reshape <- gather(center_df, features, values, Ta:PPT_271_365)
...
save(output,file = paste0("output/kmeans_shortPPT_",MinDate,MaxDate,"_",k,"cluster_output_",Site,".Rdata"))
