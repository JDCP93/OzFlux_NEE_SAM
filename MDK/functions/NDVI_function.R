...
fn_gapfill <- function(dat){
  ...
  dat$ndvi_fill = dat$ndvi
  dat <- dat %>% fill(ndvi_fill,.direction = 'downup')
...
# VegIndex$site[VegIndex$site=="Great Western Woodlands"] = "GreatWesternWoodlands"

save(VegIndex,file = "VegIndex.Rdata")
