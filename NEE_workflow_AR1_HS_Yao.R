...
load('./HowardSprings_Input_Yao.Rdata') # change these to functions
...
NEE_obs = `nee_input_data`$NEE[-(1:365)]

NEE.res = NEE_pred - NEE_obs
Nmem = nee_input_data$Nmem
...
save(AR1.res, file=paste('NEE_Yao_AR1_output_site_HS_', Sys.Date(),'.rda', sep = ''))
