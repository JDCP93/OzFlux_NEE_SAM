...
load('./NEE_input_AU-Stp.rda') # change these to functions
...
parJagsModel(cl, name = 'par_nee_model', file = NEEModel_current, data = `nee_input_data`,
...
save(nee_daily, file=paste('NEE_Yao_current_output_site_SP_', Sys.Date(),'.rda', sep = ''))
