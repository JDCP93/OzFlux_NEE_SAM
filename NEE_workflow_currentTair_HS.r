...
parJagsModel(cl, name = 'par_nee_model', file = NEEModel_currentTair, data = `HowardSprings_Input`,
...
save(nee_daily, file=paste('NEE_currentTair_output_site_HS_', Sys.Date(),'.rda', sep = ''))
