...
load('./HowardSprings_Input_2013-01-01_2017-12-31.Rdata') # change these to functions
...
save(nee_daily, file=paste('NEE_current_output_match_site_HS_', Sys.Date(),'.rda', sep = ''))
