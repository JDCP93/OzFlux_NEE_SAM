...
if (Split == 1){
  load(paste0(Site,'_Input_2003-01-01_2007-12-31.Rdata'))
  assign("Input",eval(as.name(name)))
  
  # Find the output files available
  File = list.files("results",pattern = paste0("NEE_output_split1_site_",SiteCode))
  ...
  # Find the output files available
  File = list.files("results",pattern = paste0("NEE_current_output_split1_site_",SiteCode))
  # Read the data into R 
  load(paste0("results/",File))
  # data inside is called "nee_daily"
  ...
  # Find the output files available
  File = list.files("results",pattern = paste0("NEE_AR1_output_split1_site_",SiteCode))
  # Read the data into R 
  load(paste0("results/",File))
  # data inside is called "nee_daily"
  assign('AR1',AR1.res)
  ...
  load(paste0(Site,'_Input_2008-01-01_2012-12-31.Rdata'))
  assign("Input",eval(as.name(name)))
  
  # Find the output files available
  File = list.files("results",pattern = paste0("NEE_output_split2_site_",SiteCode))
  # Read the data into R 
  load(paste0("results/",File))
  # data inside is called "nee_daily"
  assign('SAM',nee_daily)
  ...
  # Find the output files available
  File = list.files("results",pattern = paste0("NEE_current_output_split2_site_",SiteCode))
  # Read the data into R 
  load(paste0("results/",File))
  # data inside is called "nee_daily"
  assign('CUR',nee_daily)
  ...
  # Find the output files available
  File = list.files("results",pattern = paste0("NEE_AR1_output_split2_site_",SiteCode))
  # Read the data into R 
  load(paste0("results/",File))
  # data inside is called "nee_daily"
  assign('AR1',AR1.res)
