...
parJagsModel(cl, name = 'par_nee_model', file = NEEModel_currentSWR, data = `HowardSprings_Input`,
...
save(nee_daily, file=paste('NEE_currentSWR_output_site_HS_', Sys.Date(),'.rda', sep = ''))
