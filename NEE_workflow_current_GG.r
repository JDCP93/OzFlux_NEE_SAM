...
load('./Gingin_Input_NDVI.Rdata') # change these to functions
attach(`Gingin_Input`)
...
parJagsModel(cl, name = 'par_nee_model', file = NEEModel_current, data = `Gingin_Input`,
...
save(nee_daily, file=paste('NEE_current_output_site_GG_', Sys.Date(),'.rda', sep = ''))
