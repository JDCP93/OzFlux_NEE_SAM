...
load('./HowardSprings_Input_2003-01-01_2007-12-31.Rdata') # change these to functions
...
save(nee_daily, file=paste('NEE_current_output_split1_site_HS_', Sys.Date(),'.rda', sep = ''))
