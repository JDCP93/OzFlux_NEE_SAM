...
load('./SturtPlains_Input_2013-01-01_2017-12-31.Rdata') # change these to functions
...
parJagsModel(cl, name = 'par_nee_model', file = NEEModel_current, data = `SturtPlains_Input`,
...
save(nee_daily, file=paste('NEE_current_output_match_site_SP_', Sys.Date(),'.rda', sep = ''))
