...
parJagsModel(cl, name = 'par_nee_model', file = NEEModel_current, data = `DryRiver_Input`,
...
save(nee_daily, file=paste('NEE_current_output_match_site_DR_', Sys.Date(),'.rda', sep = ''))
