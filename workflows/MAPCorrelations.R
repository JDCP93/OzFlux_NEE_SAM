...
# Test for normality
# Need the p-value to be greater than 0.05
shapiro.test(NEEdf$Value[NEEdf$Model=="Biological Memory (AR1)" & NEEdf$Metric=="R^2"])
shapiro.test(NEEdf$Value[NEEdf$Model=="Biological Memory (AR1)" & NEEdf$Metric=="R^2" & NEEdf$Site %in% c("AU-ASM","AU-DaS","AU-Dry","AU-How","AU-Stp","AU-TTE")])
shapiro.test(NEEdf$Value[NEEdf$Model=="Biological Memory (AR1)" & NEEdf$Metric=="R^2" & NEEdf$Site %in% c("AU-Cpr","AU-Cum","AU-Gin","AU-GWW","AU-Tum","AU-Whr","AU-Wom")])

shapiro.test(WorldClimMetrics$AnnualPPT)
shapiro.test(WorldClimMetrics$AnnualPPT[WorldClimMetrics$Transect=="NATT"])
shapiro.test(WorldClimMetrics$AnnualPPT[WorldClimMetrics$Transect=="SAWS"])
...
# Test for normality
# Need the p-value to be greater than 0.05
shapiro.test(LEdf$Value[LEdf$Model=="Biological Memory (AR1)" & LEdf$Metric=="R^2"])
shapiro.test(LEdf$Value[LEdf$Model=="Biological Memory (AR1)" & LEdf$Metric=="R^2" & LEdf$Site %in% c("AU-ASM","AU-DaS","AU-Dry","AU-How","AU-Stp","AU-TTE")])
shapiro.test(LEdf$Value[LEdf$Model=="Biological Memory (AR1)" & LEdf$Metric=="R^2" & LEdf$Site %in% c("AU-Cpr","AU-Cum","AU-Gin","AU-GWW","AU-Tum","AU-Whr","AU-Wom")])
