...
load('./inputs/AU-ASM_Input_noSWC.Rdata') 
data = `AU-ASM_Input`
...
output <- jags.parallel(model.file = 'NEEModel_noSWC_r2jags.R',
...
output = list("output.mcmc"=output.mcmc,
              ...
              "pD" = pD)
# Save the results
save(output, file=paste('NEE_output_noSWC_AU-ASM_', Sys.Date(),'.Rdata', sep = ''))
