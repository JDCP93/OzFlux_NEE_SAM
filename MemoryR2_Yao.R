MemoryR2_Yao <- function(Site,SiteCode){
...
# Find the output files available
File = list.files("results",pattern = paste0("NEE_Yao_current_output_site_",SiteCode))
# Read the data into R 
load(paste0("results/",File))
# data inside is called "nee_daily"
...
# Find the output files available
File = list.files("results",pattern = paste0("NEE_Yao_AR1_output_site_",SiteCode))
# Read the data into R 
load(paste0("results/",File))
# data inside is called "nee_daily"
assign('AR1',AR1.res)
