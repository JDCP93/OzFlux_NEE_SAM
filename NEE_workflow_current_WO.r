...
load('./Whroo_Input_NDVI.Rdata') # change these to functions
attach(`Whroo_Input`)
...
parJagsModel(cl, name = 'par_nee_model', file = NEEModel_current, data = `Whroo_Input`,
...
save(nee_daily, file=paste('NEE_current_output_site_WO_', Sys.Date(),'.rda', sep = ''))
