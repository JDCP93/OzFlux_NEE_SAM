...
load('./HS_Input_CABLE.Rdata') # change these to functions
attach(`HS_Input`)
...
parJagsModel(cl, name = 'par_nee_model', file = NEEModel_current, data = `HS_Input`,
...
save(nee_daily, file=paste('NEE_CABLE_current_output_site_HS_', Sys.Date(),'.rda', sep = ''))
