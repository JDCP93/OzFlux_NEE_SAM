...
parJagsModel(cl, name = 'par_nee_model', file = NEEModel_current, data = `AliceSprings_Input`,
...
save(nee_daily, file=paste('NEE_current_output_site_AS_', Sys.Date(),'.rda', sep = ''))
