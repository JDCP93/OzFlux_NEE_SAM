...
NEE_currentNDVI_kmean = function(Site){
...
colnames(climate) = c("Ta",
                      ...
                      "Sws",
                      "NDVI")
# Remove duplicate Sws and PPT intercept
climate = climate[,-5]
...
save(output,file = paste0("alternate/RTPVS/results/NEE_output_kmean_currentNDVI_RTPVS_",Site,".Rdata"))
