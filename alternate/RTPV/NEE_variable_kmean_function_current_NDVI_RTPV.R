...
NEE_current_NDVI_variable_kmean_RTPV = function(Site){
...
message("Finding optimal k for k-means clustering with NDVI and current climate for ",Site, " at ", Sys.time())
...
save(output,file = paste0("alternate/RTPV/results/NEE_output_kmean_current_NDVI_RTPV_",Site,".Rdata"))
