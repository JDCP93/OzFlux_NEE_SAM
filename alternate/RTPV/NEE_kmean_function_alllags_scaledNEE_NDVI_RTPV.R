...
NEE_alllags_scaledNEE_NDVI_kmean_RTPV = function(Site,k){
...
save(output,file = paste0("alternate/RTPV/results/NEE_output_",k,"cluster_kmean_alllags_scaledNEE_NDVI_RTPV_",Site,".Rdata"))
