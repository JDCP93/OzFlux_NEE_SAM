...
colnames(climate) = c("Ta",
                      ...
                      "PPT_180_269",
                      "PPT_270_365")
# Remove Sws and PPT intercept
climate = climate[,-c(4,5,6)]
...
save(output,file = paste0("alternate/RTPV/results/NEE_output_kmean_RTPV_",Site,".Rdata"))
