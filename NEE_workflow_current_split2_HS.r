...
load('./HowardSprings_Input_2008-01-01_2012-12-31.Rdata') # change these to functions
...
parJagsModel(cl, name = 'par_nee_model', file = NEEModel_current, data = `HowardSprings_Input`,
...
save(nee_daily, file=paste('NEE_current_output_split2_site_HS_', Sys.Date(),'.rda', sep = ''))
