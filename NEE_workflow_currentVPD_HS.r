...
parJagsModel(cl, name = 'par_nee_model', file = NEEModel_currentVPD, data = `HowardSprings_Input`,
...
save(nee_daily, file=paste('NEE_currentVPD_output_site_HS_', Sys.Date(),'.rda', sep = ''))
