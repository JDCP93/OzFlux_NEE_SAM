...
load('./DalyUncleared_Input_2013-01-01_2017-12-31.Rdata') # change these to functions
attach(`DalyUncleared_Input`)
...
parJagsModel(cl, name = 'par_nee_model', file = NEEModel_current, data = `DalyUncleared_Input`,
...
save(nee_daily, file=paste('NEE_current_output_match_site_DU_', Sys.Date(),'.rda', sep = ''))
  

rm(nee_daily)

detach(`DalyUncleared_Input`)
stopCluster(cl)
