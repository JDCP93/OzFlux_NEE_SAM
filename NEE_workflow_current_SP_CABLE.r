...
load('./SP_Input_CABLE.Rdata') # change these to functions
attach(`SP_Input`)
...
parJagsModel(cl, name = 'par_nee_model', file = NEEModel_current, data = `SP_Input`,
...
save(nee_daily, file=paste('NEE_current_output_site_SP_CABLE_', Sys.Date(),'.rda', sep = ''))
