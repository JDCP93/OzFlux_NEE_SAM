...
parJagsModel(cl, name = 'par_nee_model', file = NEEModel_currentVPD, data = `SturtPlains_Input`,
...
save(nee_daily, file=paste('NEE_currentVPD_output_site_SP_', Sys.Date(),'.rda', sep = ''))
