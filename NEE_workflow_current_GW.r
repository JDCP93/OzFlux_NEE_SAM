...
parJagsModel(cl, name = 'par_nee_model', file = NEEModel_current, data = `GreatWesternWoodlands_Input`,
...
save(nee_daily, file=paste('NEE_current_output_site_GW_', Sys.Date(),'.rda', sep = ''))
